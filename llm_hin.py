...
from tensorflow.keras.layers import Embedding, LSTM, Dense, Dropout, LayerNormalization, Conv1D, AveragePooling1D, Input
from tensorflow.keras.layers import MultiHeadAttention, Layer, Concatenate
...
model = tf.keras.models.load_model('/content/drive/MyDrive/merged_model/HINAI_upgraded_with_transformer.h5', custom_objects={'TransformerBlock': TransformerBlock})
