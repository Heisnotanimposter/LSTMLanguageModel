...
# Add a Dense layer with an identity activation function (or 'linear', which is the default)
model.add(Dense(128, activation='linear'))

# Add the output layer with an identity activation function for regression
